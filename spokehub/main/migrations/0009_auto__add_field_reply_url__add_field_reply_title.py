...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reply.url'
        db.add_column(u'main_reply', 'url',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Reply.title'
        db.add_column(u'main_reply', 'title',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reply.url'
        db.delete_column(u'main_reply', 'url')

        # Deleting field 'Reply.title'
        db.delete_column(u'main_reply', 'title')
