...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkSample'
        db.create_table(u'main_worksample', (
        ...
        db.send_create_signal(u'main', ['WorkSample'])


    def backwards(self, orm):
        # Deleting model 'WorkSample'
        db.delete_table(u'main_worksample')
    ...
    models = {
        ...
        u'main.item': {
            'Meta': {'ordering': "['section', 'added']", 'object_name': 'Item'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'body': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'section': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
